...
//        echo($block.$number.$name.$subject.$complaint);
        ...
        $sql = "INSERT INTO COMPLAINTS(APT_BLOCK,APT_NUM,NAME,SUBJECT,COMP_BODY,DATE_FILED,) VALUES('$block','$number','$name','$subject','$complaint','$date','$t')";
    ...
    <div class="jumbotron">
        ...
        <?php $conn->close(); ?>
        <hr class="my-4">
        <p>Your feedback helps in making the Tsavo Suburbs Community a better place to live in</p>
    ...
    <div class="jumbotron">
        <h1 class="display-4">Not occupied :(</h1>
